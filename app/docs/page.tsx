  ...
  return (
    <>
      ...
      <p className="lead">
        ...
        <code> claude-code</code> that ships as a single 8.8&nbsp;MB static binary.
      </p>
      ...
      <ul>
        ...
        <li><strong>One static binary.</strong> 8.8 MB. <code>curl | chmod +x | run</code>. No version drift between machines.</li>
